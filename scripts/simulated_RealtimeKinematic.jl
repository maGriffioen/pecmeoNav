...
function receiverClockODE(x::Array{<:Number, 1}, t::Number)
    ...
    dxdy[2] = dxdy[1] * (1/sqrt(1- (1904.49^2 / c^2)))  #Clock time rate
    #x[1] = t',
    #x[2] = t'_c
    return dxdy
end
...
@time simulatedMeasurements = simulateMeasurements(trueMeasurementTimes, receiverClockMeasurementTimes, moonSat, navcon, recSettings, txSettings;
